...
const DeckList: React.FC = () => {
    ...
    const HeaderButtons = () => (
        <div style={styles.headerButtons}>
            ...
            >
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ overflow: 'visible', width: '20px', height: '20px' }}>
            ...
            >
                <svg className="glass-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ width: '20px', height: '20px' }}>
