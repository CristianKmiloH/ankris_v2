    ...
    const FilterToggle = () => (
        <button
            ...
            style={{
                ...
                marginTop: '12px' // Spacing from buttons above
            }}
        >
            <svg width="20" height="20" viewBox="0 0 24 24" fill={showFavoritesOnly ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
